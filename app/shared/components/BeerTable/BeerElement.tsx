...
import { SubElementType } from "./types/beerTable";


export default function BeerElement(props: PropsBeerElementType) {

  return (
    <div onClick={() => props.onShowElementInfo(props.subElement)} className={`flex items-center relative w-20 h-20 leading-none font-semibold ${props.subElement.bgColor} border-2 ${props.subElement.borderColor} cursor-pointer lg:hover:scale-150 lg:hover:z-10 lg:duration-300`}>
